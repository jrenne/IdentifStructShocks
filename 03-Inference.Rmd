...
* Monte Carlo method (@Hamilton_1994) (Section \@ref(MonteCarlo));
* Asymptotic normal approximation (@Lutkepohl_1990), or Delta method (Section \@ref(Delta));
* Bootstrap method (@Kilian_1998) (Sections \@ref(Bootstrap1) and \@ref(BootstrapAfter)).
...
```{r inference1bis, fig.align = 'left-aligned', out.width = "95%", fig.cap = "Estimated IRF associated with a monetary policy shock (black line) with simulated IRFs (red lines) and median IRF (blue line); Monte Carlo method.",warning=FALSE,message=FALSE}
...
<!-- The following lines of code can be used to get approximate confidence intervals for IRFs.
...
a. a sample of residuals from the distribution $\mathcal{N}(0,BB')$ (**parametric approach**), or
...
## Bootstrap-after-bootstrap {#BootstrapAfter}
