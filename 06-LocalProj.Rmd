...
\end{equation}
Because the residuals $u_{i,j,t+h}$ are autocorrelated (for $h>0$), estimates of the covariance of the OLS estimators of the $\Psi_{i,j,h}$ then have to be based on robust estimators (e.g. @Newey_West_1987). This is the core idea of the **local projection approach** proposed by @Jorda_2005.
