...
The log-likelihood function \@ref(eq:pseudolog) is computed as if the errors $\eta_{i,t}$ had the pdf $g_i (\eta_i)$. The PML estimator of matrix $B$ maximizes the pseudo log-likelihood function:
\begin{equation}
